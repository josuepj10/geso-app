...
export default function Mision() {
  return (
    <section className="overflow-x-hidden max-w-[1362px] mx-auto flex flex-col items-center gap-4 pl-10 pr-7 py-8
                        lg:flex-row lg:justify-between lg:py-40 lg:pr-14  ">
      
      {/* Texto de la sección */}
      <div className="lg:w-1/2 my-10 -ml-10 -mr-7 lg:-mr-4 lg:pr-6">
        <Reveal>
          <h1 className="my-5 text-4xl font-bold text-[#5B1780]">Misión</h1>
