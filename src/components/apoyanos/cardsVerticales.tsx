    ...
    <div className="flex flex-wrap lg:grid lg:grid-cols-3 justify-center gap-8 max-w-[1420px] mx-auto ">
      {/* <li>Formar líderes comunitarios.</li> */}
        <CardIcons
          ...
          text={<div> 
                  <p>Tu aporte económico permite que sigamos desarrollando proyectos sociales y culturales con perspectiva de 
                  género en Costa Rica y la región. Con tu ayuda podemos: </p>
                  <ul>
          ...
          href=""
          media={
              (lottieRef) => <VolunteerIcon lottieRef={lottieRef} />
          }
          animationDelay={0}
        />
        <CardIcons
          title="Únete como voluntario/a"
          text={<div><p>¿Quieres ser parte activa del cambio?
              En GESO abrimos espacios para que estudiantes, profesionales y activistas aporten sus conocimientos en:</p>
              <ul>
          ...
          href=""
          media={
              (lottieRef) => <HighFiveIcon lottieRef={lottieRef} />
          }
          animationDelay={700}
        />
        <CardIcons
          title="Alianzas y apoyo institucional"
          text={<div><p>El trabajo colaborativo potencia nuestro impacto. Por eso construimos alianzas con:</p>
              <ul>
          ...
          href=""
          media={
              (lottieRef) => <PartnershipIcon lottieRef={lottieRef} />
          }
          animationDelay={1400}
        />
    </div>
