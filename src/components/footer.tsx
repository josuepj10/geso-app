    ...
    <footer className="bg-gray-900 py-8 w-full text-gray-300">
      <div className="flex flex-col md:flex-row items-start mx-auto px-6 w-full gap-8">
        ...
        <div className="flex-1 text-left">
          <div className="text-sm leading-7">
            ...
            2 cuadras al Sur de la Municipalidad.
            <br />
            San José, Costa Rica.
            <br />
            Teléfono: (506) 2271-2247.
            <br />
        ...
        >
          <Link
            href="/"
            className="font-semibold hover:underline text-gray-300 w-fit"
          >
            Inicio
          </Link>
          ...
          <div className="flex flex-col items-start">
            ...
            <Link href="/nosotros/historia" className="hover:underline mb-2">
              Historia
            </Link>
            <Link href="/nosotros/equipo" className="hover:underline mb-2">
              Equipo
            </Link>
            <Link href="/nosotros/principios" className="hover:underline mb-2">
              Principios
            </Link>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <Link href="/recursos/entrevistas" className="hover:underline mb-2">
              Entrevistas
            </Link>
            <Link href="/recursos/archivos" className="hover:underline mb-2">
              Archivos
            </Link>
          </div>
          ...
          <Link href="/impacto" className="font-semibold hover:underline w-fit">
            Impacto
          </Link>
          <Link href="/apoyo" className="font-semibold hover:underline w-fit">
            Apóyanos
          </Link>
          <Link
            href="/contacto"
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex gap-4 mt-4">
            <Link
              href="https://www.facebook.com/FundacionGESO#"
              target="_blank"
            ...
            <Link
              href="https://www.instagram.com/fundaciongeso/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <Link
              href="https://www.youtube.com/channel/UCGghK4Q0ZFTG6lOay5qO1BQ"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 md:px-4 text-sm relative">
        <div className="text-center md:text-left">
          &copy; {new Date().getFullYear()} Fundación GESO. Todos los derechos
          reservados.
        </div>
